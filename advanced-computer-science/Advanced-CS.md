## Welcome !
Core of computer science, this is where things get really deep and you learn real fundamentals taught at university.

### Learn how to use tools effectively with MIT
Making apps is a obvious approach to practicing what you've learned. Make sure to check out this resource from MIT to discover the power of tooling!  
...
:-- | :--: | :--: | :--: 
[How to Code - Simple Data](https://www.edx.org/course/how-to-code-simple-data) [(textbook)](https://htdp.org/2022-8-7/Book/index.html) | 7 weeks | 8-10 hours/week | none |
...
:-- | :--: | :--: | :--: | :--: 
[Calculus 1A: Differentiation](https://openlearninglibrary.mit.edu/courses/course-v1:MITx+18.01.1x+2T2019/about) ([alt](https://ocw.mit.edu/courses/mathematics/18-01sc-single-variable-calculus-fall-2010/index.htm)) | 13 weeks | 6-10 hours/week | The alternate covers this and the following 2 courses | [high school math] |
...
[Software Engineering: Introduction](https://www.edx.org/course/software-engineering-introduction) | 6 weeks | 8-10 hours/week | Core Programming
...
Upon successful completion of all required courses in Core CS, students are encouraged to explore a selection of courses from Advanced CS based on their individual interests. While it is not necessary to take every course within a specific subcategory, it is highly recommended that students enroll in all courses relevant to their intended field of specialization. This approach ensures that students acquire the necessary knowledge and skills required for their desired career path.
...
[Probability](https://projects.iq.harvard.edu/stat110/home) | 15 weeks | 5-10 hours/week | [Differentiation and Integration](https://www.edx.org/course/calculus-1b-integration)

## Congratulations

You have reached the end of this journey. But what does this mean? You are now ready to tackle your own problems/projects with the knowledge you've acquired!

However, there are many ways of doing this.   

We recommend thinking of a problem you would like to solve, or find existing projects that need help via sites such as [CodeTriage](https://www.codetriage.com/) or [First Timers Only](https://www.firsttimersonly.com/).

## Whats Next?

- Acquire a developer job! Try LinkedIn!
- Check out the [readings](../more/readings.md) for books you can read that will sharpen your skills and expand your knowledge.
- Join a local developer meetup. Twitter is great for these things!
- Pay attention to new breakthroughs and security breaches in tech
![keep practicing and never give up!](https://data.nextshark.com/wp-content/uploads/2017/12/Never-Give-Up.png)